            ...
            <div class="row">
                ...
                <form action="{{url('/post_tob/'.$user->id)}}" method="post">
                    ...
                    <div class="col-lg-6 col-xl-6 col-md-6 col-sm-12 d-flex justify-content-center flex-column">
                        ...
                        <select class="mt-3" name="business" id="business">
                            <option value="retail_marketing">Retail Marketing</option>
                            <option value="fashion">Fashion</option>
                            <option value="Partnership">Partnership</option>
                        </select>

                        <button class="btn-link mt-3 submit button mb-4" type="submit">Continue</button>

                        <!-- <button class="btn-link mt-3 submit button mb-4">
                            Continue
                        </button> -->
                    </div>
                </form>
