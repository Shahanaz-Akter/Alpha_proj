            ...
            <div class="row d-flex justify-content-between ">
                ...
                <form action="{{url('/post_resetpin')}}" method="post">
                    ...
                    <div class="col-lg-6 col-xl-6 col-md-6 col-sm-12 d-flex justify-content-center flex-column">
                        ...
                        <!-- <div class="">
                            <div class="first-example">
                                <input type="password" id="password-field2" placeholder="Confirm Pin" name="confirm_pin">
                                <i id="pass-status2" class="fa fa-eye" aria-hidden="true" onClick="viewPassword2()"></i>
                            </div>

                        </div> -->

                        <button class="btn-link mt-3 button submit mb-4">
                            Reset Pin
                        </button>
